...
# Multiplicative version of encryption
...
# Additive version of encryption
def EGA_encrypt(message, public_key):
    r = randint(1, PARAM_Q - 1)
    c1 = pow(PARAM_G, r, PARAM_P)
    c2 = (pow(public_key, r, PARAM_P) * pow(PARAM_G, message, PARAM_P)) % PARAM_P
    return r, (c1, c2)

# Decrypt for both versions
